  ...
  return (
    <div className='min-h-screen bg-slate-50'>
      <div className='max-w-6xl mx-auto p-6'>
        ...
        {/* tab */}
        <div className='inline-flex flex-warp items-center border border-gray-200 rounded-md bg-white shadow-sm'>
          {
            dataArray.map((tab)=>(
              <button onClick={()=>setCurrentTab(tab.label)} key={tab.label} className={` cursor-pointer flex items-center px-3 py-2 text-sm rounded-md transition-colors ${currentTab===tab.label ? 'bg-white font-medium text-black':'text-gray-500 hover:text-black'}`}>

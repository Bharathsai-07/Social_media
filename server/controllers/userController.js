...
//find user by email,id,location,name
...
export const sendConnectionRequest=async(req,res)=>{
    try{
        ...
        if(connectionRequests.length>=20){
            return res.json({success:false,message:"You have reached the limit of connection requests for today"})
        }
